...
const Hero = () => {
  ...
  return (
    <div className="flex relative flex-col">
      <div
        className={`py-20 relative flex flex-col-reverse justify-center sm:justify-between sm:flex-row px-[4vw] sm:px-[5vw] md:px-[7vw] lg:px-[9vw] ${
          theme
      ...
      >
        ...
        <section className="sm:w-2/3 w-full relative flex flex-col justify-start items-start">
          ...
          <p className="mb-3 text-lg leading-relaxed w-full">
            A passionate{" "}
            <strong className="text-[#10B981]">Full-Stack Developer</strong>{" "}
            specializing in{" "}
            <strong>MERN & Next.js</strong>. I love building modern,
            scalable, and user-friendly applications with clean UI and solid
          ...
          <div className="flex flex-col gap-2 mt-4">
            <div className="flex items-center gap-2">
              <img
                src={theme ? asset.location_light : asset.my}
                alt="Location Icon"
              />
              <p className="text-lg">Faisalabad, Pakistan</p>
            </div>
            <div className="flex items-center">
              <motion.div
                ...
                transition={{ repeat: Infinity, duration: 1.9 }}
              />
              <p className="ml-4 text-lg">Open to freelance & collaborations 🚀</p>
            </div>
          </div>
